...
<div class="bs-docs-example tooltip-demo" style="padding-right: 20px;">
    <br>
        <a href="http://www.comptoneye.com" target="_blank" class="btn btn-large btn-block btn-primary"><strong>Get Comptoneye Appointment Premium Plugin</strong></a>
        <table class="table table-hover table-bordered" style="background-color: #FFFFFF;">
            ...
            <tr class="alert alert-info">
                ...
                <td style="text-align: center;"><a class="btn btn-large btn-warning" href="http://comptoneye.com/pricing/" target="_blank"><strong>Buy Premium</strong></a></td>
            </tr>
