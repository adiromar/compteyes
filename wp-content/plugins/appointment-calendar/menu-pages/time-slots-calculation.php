...
if($TodaysAllDayEvent) {
    echo "<div class='alert alert-error'>" . __("Sorry! No time available today.", "comptoneye") . "</div>";
    echo "<a class='btn btn-primary' id='back' onclick='backtodate()'>&larr; " . __("Back", "comptoneye") . "</a>";
} else {
    echo "<div class='alert alert-info'>" . __("Available Time For", "comptoneye") . " <strong>'$ServiceData->name'</strong> " . __("On", "comptoneye") . "  <strong>'".date("l, jS M.", strtotime($AppointmentDate))."'</strong></div>";
