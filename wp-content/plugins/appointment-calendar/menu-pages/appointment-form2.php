    ...
    <form method="post" name="selecttimesloatappointment" id="selecttimesloatappointment">
        ...
        <div class="modal-info">
            <div class="alert alert-info">
                ...
                <h4><?php _e("Schedule New Appointment", "comptoneye"); ?></h4><?php _e("Select Time & Fill Out Form", "comptoneye"); ?>
            </div>
        </div>
        ...
        <div class="modal-body">
            ...
            <div id="clientboxform" style="float:left; width:auto;" >
                ...
                if(!$Enable && !$TodaysAllDayEvent ) {
                    echo "<p align=center class='alert alert-error'><strong>" . _e("Sorry! Today's all appointments has been booked.", "comptoneye") . "</strong> <a class='btn btn-primary' id='back' onclick='backtodate()'>&larr; " . _e("Back", "comptoneye") . "</a></p>";
                ...
                <div style="margin-left:0px; width:500px;">
                    ...
                    <table class="table">
                        <tr>
                            <th valign="top" scope="row" ><?php _e("Name", "comptoneye"); ?></th>
                            <td valign="top"><strong>:</strong></td>
                            <td valign="top"><input type="text" name="name" id="name" class="inputwidth"/></td>
                        </tr>
                        <tr>
                            <th valign="top" scope="row" ><?php _e("Email", "comptoneye"); ?></th>
                            <td valign="top"><strong>:</strong></td>
                            <td valign="top"><input type="text" name="email" id="email" class="inputwidth"></td>
                        </tr>
                        <tr>
                            <th valign="top" scope="row" ><?php _e("Phone", "comptoneye"); ?></th>
                            <td valign="top"><strong>:</strong></td>
                            <td valign="top">
                                <input name="phone" type="text" class="inputwidth" id="phone" maxlength="12"/>
                                <br/><label><?php _e("Eg : 1234567890", "comptoneye"); ?></label>
                            </td>
                        </tr>
                        <tr>
                            <th valign="top" scope="row" ><?php _e("Special Instruction", "comptoneye"); ?></th>
                            <td valign="top"><strong>:</strong></td>
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                ...
                                <button name="booknowapp" class="btn btn-success" type="button" id="booknowapp" onclick="checkvalidation()"><i class="icon-ok icon-white"></i> <?php _e("Book Now", "comptoneye"); ?></button>
                                <div id="loading2" style="display:none; color:#1FCB4A;">
                                    <?php _e('Scheduling appointment please wait...', 'comptoneye'); ?><img src="<?php echo plugins_url()."/appointment-calendar/images/loading.gif"; ?>" />
                                </div>
                            </td>
                        </tr>
                    </table>
