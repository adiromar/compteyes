...
<div class="bs-docs-example tooltip-demo">
    <div style="background:#C3D9FF; margin-bottom:10px; padding-left:10px;">
        <h3><?php _e("Export Appointments", "comptoneye"); ?></h3>
    </div>
    <table width="100%" class="table" style="background-color: #FFFFFF;">
        <tr id="select-range-tr">
            <th width="18%" align="right" scope="row"><?php _e("Select Range", "comptoneye"); ?></th>
            <td width="3%" align="center"><strong>:</strong></td>
            <td width="79%">
                <select name="select_range" id="select_range">
                    <option value="0"><?php _e("Select Range", "comptoneye"); ?></option>
                    <option value="T"><?php _e("Today's Appointment", "comptoneye"); ?></option>
                    <option value="W"><?php _e("This Week Appointment", "comptoneye"); ?></option>
                    <option value="M"><?php _e("This Month Appointment", "comptoneye"); ?></option>
                    <option value="CR"><?php _e("Custom Appointment Range", "comptoneye"); ?></option>
                    <option value="A"><?php _e("All Appointment", "comptoneye"); ?></option>
                </select>&nbsp;<a href="#" rel="tooltip" title="<?php _e("Appointment Selection Range", "comptoneye"); ?>" ><i class="icon-question-sign"></i></a>
            </td>
        </tr>
        <tr id="custom-dates1" style="display:none;">
            <th width="18%" align="right" scope="row"><?php _e("Select Start Date", "comptoneye"); ?></th>
            <td width="3%" align="center"><strong>:</strong></td>
            <td width="79%">
        ...
        <tr id="custom-dates2" style="display:none;">
            <th width="18%" align="right" scope="row"><?php _e("Select End Date", "comptoneye"); ?></th>
            <td width="3%" align="center"><strong>:</strong></td>
            <td width="79%">
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td>
                <button name="export-lists" class="btn btn-info" type="submit" id="export-lists" data-loading-text="Saving Settings" ><i class="icon-list-alt icon-white"></i> <?php _e("Export List", "comptoneye"); ?></button>
                <br><br>
                <div id="loading-img" style="display: none;">
                    <?php _e('Generating appointments list, please wait...', 'comptoneye'); ?><img src="<?php echo plugins_url("images/loading.gif", __FILE__); ?>" />
                </div>
            </td>
        </tr>
    </table>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            jQuery('#export-lists').click(function(){
                ...
                if(Range == 0)
                {
                    jQuery("#select_range").after('<span class="apcal_error">&nbsp;<br><strong><?php _e("Select any range.", "comptoneye"); ?></strong></span>');
                    return false;
                }
                ...
                if(Range == "CR") {
                    ...
                    if(StartDate == "") {
                        jQuery("#start_date").after('<span class="apcal_error">&nbsp;<br><strong><?php _e("Select any start date.", "comptoneye"); ?></strong></span>');
                        return false;
                    }
                    if(EndDate == "") {
                        jQuery("#end_date").after('<span class="apcal_error">&nbsp;<br><strong><?php _e("Select any end date.", "comptoneye"); ?></strong></span>');
                        return false;
                    }
...
<div class="bs-docs-example tooltip-demo">
    <div style="background:#C3D9FF; margin-bottom:10px; padding-left:10px;">
        <h3><?php _e("Appointments Lists", "comptoneye"); ?></h3>
    </div>
    <table class="table" style="background-color: #FFFFFF;">
        <thead>
        <tr>
            <th>#</th>
            <th><?php _e("Lists", "comptoneye"); ?></th>
            <th><?php _e("Date", "comptoneye"); ?></th>
            <th><?php _e("Time", "comptoneye"); ?></th>
            <th><?php _e("Size", "comptoneye"); ?></th>
            <th><?php _e("Action", "comptoneye"); ?></th>
        </tr>
        </thead>
        <tbody>
    <?php
        $DirName = "appointments-lists";
        $DirPath = comptoneyedir . $DirName;
		$export_url = comptoneyeurl . $DirName . '/';
        ...
        ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-mini btn-success" href="<?php echo $export_url . $File; ?>" target="_blank"><i class="icon-download-alt icon-white"></i> <strong><?php _e("Download", "comptoneye"); ?></strong></a>
                    <a class="btn btn-mini btn-danger" href="?page=apcal-export-lists&delete-file=<?php echo $File; ?>"><i class="icon-remove icon-white"></i> <strong><?php _e("Delete", "comptoneye"); ?></strong></a>
                </td>
            </tr>
               <?php
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td><a class="btn btn-small btn-danger" href="?page=apcal-export-lists&delete-file=all"><i class="icon-trash icon-white"></i> <strong><?php _e("Delete All", "comptoneye"); ?></strong></a></td>
            </tr>
            <?php
        } else {
        ?>
            <tr>
                <td colspan="6" class="alert"><strong><?php _e("Sorry! No appointment lists are available.", "comptoneye"); ?></strong></td>
            </tr>
        <?php
        }//end of else
        ?>
    ...
    if($File != 'all') {
        ...
        if( file_exists($FilePath) ) {
            ...
            if(unlink($FilePath)) {
				...
				alert("<?php _e('List successfully deleted.', 'comptoneye'); ?>"); 
				...
				alert("<?php _e('Unable to delete list or list file not exist.', 'comptoneye'); ?>"); 
        ...
        if( file_exists($DirPath) ) {
			...
			alert("<?php _e('All list file(s) successfully deleted.', 'comptoneye'); ?>"); 
