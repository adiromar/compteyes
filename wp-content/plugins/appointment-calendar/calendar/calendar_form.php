...
$sld = ( isset( $_REQUEST["selected_day"] ) ) ? filter_var($_REQUEST["selected_day"], FILTER_VALIDATE_INT) : 0;
$slm = ( isset( $_REQUEST["selected_month"] ) ) ? filter_var($_REQUEST["selected_month"], FILTER_VALIDATE_INT) : 0;
$sly = ( isset( $_REQUEST["selected_year"] ) ) ? filter_var($_REQUEST["selected_year"], FILTER_VALIDATE_INT) : 0;
$year_start = ( isset( $_REQUEST["year_start"] ) ) ? filter_var($_REQUEST["year_start"], FILTER_VALIDATE_INT) : 0;
$year_end = (isset( $_REQUEST["year_end"] ) ) ? filter_var($_REQUEST["year_end"], FILTER_VALIDATE_INT) : 0;
$startDate = (isset( $_REQUEST["str"] ) ) ? filter_var($_REQUEST["str"], FILTER_SANITIZE_STRING ) : 0;
$time_allow1 = (isset( $_REQUEST["da1"] ) ) ? filter_var($_REQUEST["da1"], FILTER_VALIDATE_INT) : "";
$time_allow2 = (isset( $_REQUEST["da2"] ) ) ? filter_var($_REQUEST["da2"], FILTER_VALIDATE_INT) : "";
...
$show_input = (isset( $_REQUEST["inp"] ) ) ? filter_var($_REQUEST["inp"], FILTER_VALIDATE_INT ) : true;
...
$sp_type = (isset( $_REQUEST["spt"] ) ) ? filter_var($_REQUEST["spt"], FILTER_VALIDATE_INT) : 0;
...
$show_weeks = (isset($_REQUEST["wks"])) ? filter_var($_REQUEST["wks"], FILTER_VALIDATE_INT) : false;
$interval = (isset($_REQUEST["int"])) ? filter_var($_REQUEST["int"], FILTER_VALIDATE_INT) : 1;
$auto_hide = (isset($_REQUEST["hid"])) ? filter_var($_REQUEST["hid"], FILTER_VALIDATE_INT) : 0;
$auto_hide_time = (isset($_REQUEST["hdt"])) ? filter_var($_REQUEST["hdt"], FILTER_VALIDATE_INT) : 1000;
...
if(isset($_REQUEST["m"]))
	$m = filter_var($_REQUEST["m"], FILTER_VALIDATE_INT);
else{
	if($slm){
		$m = $slm;
	}else{
...
if(isset($_REQUEST["y"]))
	$y = filter_var($_REQUEST["y"], FILTER_VALIDATE_INT);
else
	$y = ($cyr) ? $sly : date('Y');
