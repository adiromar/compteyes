=== Comptoneye Appointment ===
Contributors: a.ankit, farazfrank, harimaliya 
Donate Link: http://comptoneye.com/
Tags: appointment, Comptoneye Appointment, appointment booking, booking calendar, scheduling, online scheduling, appointment scheduling, booking form, calendar, schedule, online booking calendar, appointment plugin, online reservation, Reservation, event, event calendar, availability, availability calendar
...
Comptoneye Appointment is a simple but effective plugin which enables you to take online appointment bookings on your wordpress blog. If you are a consultant/doctor/lawyer etc, you can harness the power of Comptoneye Appointment. 
...
Documentation: [Wordpress Comptoneye Appointment Plugin](http://comptoneye.com/documentation-comptoneye-lite/) 

Plugin Tranlation Guide: [Comptoneye Appointment Plugin Tranlation Guide](http://comptoneye.com/appointment-calendar-Premium-Plugin-Translation-Guide.pdf) 
...
Check out the Comptoneye Appointment Premium Demo [HERE](http://comptoneye.com/demo/wordpress/) 
...
Have doubts and queries:  [Comptoneye Appointment Plugin](http://comptoneye.com/documentation-comptoneye-lite/)


== Screenshots ==

1. Comptoneye Appointment
2. Appointment Booking Form
3. Admin Panel - Booking Management
4. Admin Panel - Comptoneye Appointment
...
10. Comptoneye Appointment For Mobile Deives
